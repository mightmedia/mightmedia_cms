...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            ...
            <small><?php echo getOption('site_name'); ?> - <?php echo getOption('site_description'); ?></small>
        </div>
        <?php
            if (! empty($strError)){
                notifyMsg(
                    [
                        'type'		=> 'error',
                        'message' 	=> htmlentities($strError, ENT_QUOTES)
                    ]
                );
            }
        ?>
            ...
            <div class="body">
                <form id="admin-login" method="post">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" name="email" placeholder="<?php echo getLangText('user', 'user');?>" required autofocus>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
                        ...
                        <div class="form-line">
                            <input type="password" class="form-control" name="password" placeholder="<?php echo getLangText('user', 'password'); ?>" required>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            ...
                            <input type="hidden" name="token" value="<?php echo getSession('token'); ?>"/>

                            <button class="btn btn-block bg-deep-orange waves-effect" type="submit" name="action" value="admin-login">
    ...
    <script src="<?php echo adminUrl('themes/material/plugins/jquery-validation/jquery.validate.js'); ?>"></script>

    <!-- Custom Js -->
    <script src="<?php echo adminUrl('themes/material/js/admin.js'); ?>"></script>
    <script src="<?php echo adminUrl('themes/material/js/pages/examples/sign-in.js'); ?>"></script>
</body>
